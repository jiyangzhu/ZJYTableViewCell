...
- (void)initDefaultValues {
    _leftMarginOfTitle = 10*[[UIScreen mainScreen] scale];
    _rightMarginOfRemindLabel = 30*[[UIScreen mainScreen] scale];
    _rightMarginOfAccessory = 19*[[UIScreen mainScreen] scale];
    
    if (!_fontOfTitle) {
        _fontOfTitle = [UIFont systemFontOfSize:10.0*[[UIScreen mainScreen] scale]];
    }
    
    if (!_fontOfRemindText) {
        _fontOfRemindText = [UIFont systemFontOfSize:10.0*[[UIScreen mainScreen] scale]];
    }
...
- (void)drawAccessoryView {
    if (self.accessoryImageView) {
        ...
        return;
    } else if (self.accessoryTypeZJY == ZJYTableViewCellAccessoryNone) {
        return;
    }
